...
<AccordionGroup>
  <Accordion title="Quick Start Example" icon="rocket">
    ```go
...
<AccordionGroup>
  <Accordion title="Essential Configuration" icon="gear" defaultOpen>
  ...
  <Accordion title="Session Management" icon="database">
...
<ParamField path="MemorySession" type="bool" default="false">
  ...
  <Accordion title="Device Configuration" icon="mobile">
...
<ResponseField name="DeviceConfig" type="struct">
  <Expandable title="DeviceModel" type="string" required>
    The device model name (e.g., "IPhone", "Samsung Galaxy", "Server")
  </Expandable>
  <Expandable title="SystemVersion" type="string" required>
    Operating system version (e.g., "17.0", "13.0", "Ubuntu 20.04")
  </Expandable>
  <Expandable title="AppVersion" type="string" required>
    Application version (e.g., "1.0.0", "2.1.5")
  </Expandable>
  <Expandable title="LangCode" type="string" required>
    Language code for the application (e.g., "en", "es", "ru")
  </Expandable>
  <Expandable title="SystemLangCode" type="string" required>
    System language code (e.g., "en-US", "es-ES", "ru-RU")
  </Expandable>
  <Expandable title="LangPack" type="string">
    Language pack identifier (optional, can be empty)
  </Expandable>
</ResponseField>
  </Accordion>
...
<ParamField path="UseWebSocketTLS" type="bool" default="false">
  ...
  <Accordion title="Transport & Protocol" icon="exchange-alt">
...
<ParamField path="TestMode" type="bool" default="false">
  ...
  <Accordion title="Behavior & Features" icon="sliders">
...
<ParamField path="NoPreconnect" type="bool" default="false">
  ...
  <Accordion title="Commands & Messages" icon="terminal">
...
<ParamField path="AlbumWaitTime" type="int64" default="500">
  ...
  <Accordion title="Rate Limiting & Timeouts" icon="clock">
...
<Tip>
  For cleaner, more maintainable code, use the builder pattern instead of direct struct initialization.
</Tip>

<AccordionGroup>
  <Accordion title="Builder Example" icon="code" defaultOpen>
    ```go
  ...
  <Accordion title="Available Builder Methods" icon="list">
...
<AccordionGroup>
  <Accordion title="Production-Ready Bot Configuration" icon="robot">
    ```go
    package main
