...
<CardGroup cols={2}>
  <Card title="Check for nil" icon="shield-check">
    Always check if media/sender objects are nil before accessing
  </Card>
  <Card title="Handle errors" icon="triangle-exclamation">
    Always handle errors from reply/respond methods
  </Card>
  <Card title="Use filters" icon="filter">
    Filter messages early with FilterPrivate, FilterGroup, etc.
  </Card>
  <Card title="Conversations timeout" icon="clock">
    Set appropriate timeouts for Ask() and Conv()
  </Card>
  <Card title="Download wisely" icon="download">
