...
<Note>
  To use inline buttons with callback data, you need to enable inline mode for your bot. Go to [@BotFather](https://t.me/BotFather), select your bot, go to **Bot Settings** → **Inline Mode** and turn it on.
</Note>
