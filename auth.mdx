...
<ResponseField name="LoginOptions" type="struct">
  <Expandable title="CodeCallback" type="func() (string, error)">
    Custom function to retrieve the verification code sent to your phone. Return the code as a string or an error if retrieval fails.
  </Expandable>
  <Expandable title="PasswordCallback" type="func() (string, error)">
    Custom function to retrieve the 2FA password. Return the password as a string or an error if retrieval fails.
  </Expandable>
  <Expandable title="MaxRetries" type="int">
    Maximum number of retry attempts for invalid codes or passwords. Default is 3.
  </Expandable>
</ResponseField>
...
<ResponseField name="Session" type="struct">
  <Expandable title="Key" type="[]byte">
    The authorization key used for authentication with Telegram servers.
  </Expandable>
  <Expandable title="Hash" type="[]byte">
    SHA1 hash of the authorization key for verification purposes.
  </Expandable>
  <Expandable title="Salt" type="int64">
    Server salt used in message encryption and authentication.
  </Expandable>
  <Expandable title="Hostname" type="string">
    IP address of the data center the session is connected to.
  </Expandable>
  <Expandable title="AppID" type="int32">
